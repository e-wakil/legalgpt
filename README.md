...
![AI](https://img.shields.io/badge/Model-Mistral%20Nemo%207B-purple)
...
*   **RAG Architecture:** Uses `FAISS` to retrieve relevant legal documents (IIO format) before answering, ensuring high accuracy.
